...
这个仓库用于整理张雪峰老师的公开资料，作为纪念性索引与传记合集。
...
- `public/`：公开索引与人物传记
- `data/accounts.md`：官方/团队账号索引
- `data/books.md`：已出版图书索引
- `data/videos.md`：代表视频索引
- `data/timeline.md`：人物与作品时间线
- `data/press_and_sources.md`：重要报道与来源索引
